# Cross-sample quality annotation

Design prompt: not yet connected to the runtime. The host must prepend the Prompt section of `precomputed-deg-prompt.md`, attach accepted type proposals and the versioned evidence manifest, and provide the existing submission schemas and tools.
