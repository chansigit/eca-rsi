...
The prompt above already lists the evidence files and UMAP figures; list_evidence only repeats them.
1. One batched turn: read_evidence on a UMAP png listed above, on lineage_counts.csv and on lineage_islands.csv.
