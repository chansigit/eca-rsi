...
python -m ecarsi.control --temporal HOST:7233 start-persample spec.json
python -m ecarsi.control --temporal HOST:7233 status-persample RUN_ID
python -m ecarsi.control --temporal HOST:7233 resume-persample RUN_ID
```
